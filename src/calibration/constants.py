...
These describe physical facts about how ``the measurement set``'s B2B loopback
...
B2B_ATTENUATION_DB: float = 60.0
"""Fixed attenuator inserted only while recording the measurement set's B2B loopback
...
deconvolving the measurements with the B2B reference."""
